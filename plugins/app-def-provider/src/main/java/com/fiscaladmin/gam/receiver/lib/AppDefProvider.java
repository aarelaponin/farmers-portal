package com.fiscaladmin.gam.receiver.lib;

import com.fiscaladmin.gam.receiver.lib.base.BaseServiceProvider;
import com.fiscaladmin.gam.receiver.service.RegistrationService;
...
import com.fiscaladmin.gam.receiver.service.ApiRequestProcessor;
import com.fiscaladmin.gam.receiver.service.RegistrationServiceFactory;
 ...
 */
public class AppDefProvider extends BaseServiceProvider implements PropertyEditable {
    ...
    protected ApiRequestProcessor createRequestProcessor(String serviceId, String requestBody) {
        ...
        if ("true".equalsIgnoreCase(useGovStack)) {
            ...
            try {
                ...
                RegistrationService service = new RegistrationService(null, null, null, null);
